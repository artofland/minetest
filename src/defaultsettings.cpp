...
void set_default_settings()
{
	...
	settings->setDefault("serverlist_url", "servers.artof.land");
	...
	settings->setDefault("keymap_hotbar_next", "KEY_KEY_O");
	...
	settings->setDefault("font_path", porting::getDataPath("fonts" DIR_DELIM "Monterrat-Regular.ttf"));
	settings->setDefault("font_path_italic", porting::getDataPath("fonts" DIR_DELIM "Monterrat-Italic.ttf"));
	settings->setDefault("font_path_bold", porting::getDataPath("fonts" DIR_DELIM "Monterrat-Bold.ttf"));
	settings->setDefault("font_path_bold_italic", porting::getDataPath("fonts" DIR_DELIM "Monterrat-BoldItalic.ttf"));
	...
	settings->setDefault("mono_font_path", porting::getDataPath("fonts" DIR_DELIM "Monterrat-Regular.ttf"));
	settings->setDefault("mono_font_path_italic", porting::getDataPath("fonts" DIR_DELIM "Monterrat-Italic.ttf"));
	settings->setDefault("mono_font_path_bold", porting::getDataPath("fonts" DIR_DELIM "Monterrat-Bold.ttf"));
	settings->setDefault("mono_font_path_bold_italic", porting::getDataPath("fonts" DIR_DELIM "Monterrat-BoldItalic.ttf"));
